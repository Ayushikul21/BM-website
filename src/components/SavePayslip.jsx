...
export default function SavePayslip() {
  ...
  function handleSave() {
    // Here you can replace with an API call or localStorage as needed
    // For this example, we save to localStorage
    localStorage.setItem("payslipFormData", JSON.stringify(form));
    showStatusMessage("Payslip data saved successfully!", "success");
  }
      ...
      <style>{`
        * {margin:0; padding:0; box-sizing:border-box;}
        ...
        .save-btn {
          ...
          background: linear-gradient(45deg, #10ac84, #06b79e); color:white;
        }
        .save-btn:hover {
      ...
      <main className="main-content">
        <div className="form-container" id="formContainer">
          ...
          >
            ...
            <div
              id="statusMessage"
              className={`status-message${status.show ? " show" : ""} ${status.type}`}
            >
              {status.message}
            </div>
          </form>
